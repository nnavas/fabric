...
func (x *GossipMessage) GetSpanningTree() *SpanningTreeMsg {
	if x, ok := x.GetContent().(*GossipMessage_SpanningTree); ok {
		return x.SpanningTree
	}
	return nil
}
...
type GossipMessage_SpanningTree struct {
	// NN: adding spanning_tree to GossipMessage
	SpanningTree *SpanningTreeMsg `protobuf:"bytes,26,opt,name=spanning_tree,json=spanningTree,proto3,oneof"`
}
...
func (*GossipMessage_SpanningTree) isGossipMessage_Content() {}
...
type SpanningTreeMsg struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RootPkiId   []byte `protobuf:"bytes,1,opt,name=root_pki_id,json=rootPkiId,proto3" json:"root_pki_id,omitempty"`
	RootIncNum  uint64 `protobuf:"varint,2,opt,name=root_inc_num,json=rootIncNum,proto3" json:"root_inc_num,omitempty"`
	RootSeqNum  uint64 `protobuf:"varint,3,opt,name=root_seq_num,json=rootSeqNum,proto3" json:"root_seq_num,omitempty"`
	Distance    uint32 `protobuf:"varint,4,opt,name=distance,proto3" json:"distance,omitempty"`
	SenderPkiId []byte `protobuf:"bytes,5,opt,name=sender_pki_id,json=senderPkiId,proto3" json:"sender_pki_id,omitempty"`
	PathCost    uint32 `protobuf:"varint,6,opt,name=path_cost,json=pathCost,proto3" json:"path_cost,omitempty"`
}

func (x *SpanningTreeMsg) Reset() {
	*x = SpanningTreeMsg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_gossip_message_proto_msgTypes[34]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SpanningTreeMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpanningTreeMsg) ProtoMessage() {}

func (x *SpanningTreeMsg) ProtoReflect() protoreflect.Message {
	mi := &file_gossip_message_proto_msgTypes[34]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpanningTreeMsg.ProtoReflect.Descriptor instead.
func (*SpanningTreeMsg) Descriptor() ([]byte, []int) {
	return file_gossip_message_proto_rawDescGZIP(), []int{34}
}

func (x *SpanningTreeMsg) GetRootPkiId() []byte {
	if x != nil {
		return x.RootPkiId
	}
	return nil
...
func (x *SpanningTreeMsg) GetRootIncNum() uint64 {
	if x != nil {
		return x.RootIncNum
	}
	return 0
...
func (x *SpanningTreeMsg) GetRootSeqNum() uint64 {
	if x != nil {
		return x.RootSeqNum
	}
	return 0
...
func (x *SpanningTreeMsg) GetDistance() uint32 {
	if x != nil {
		return x.Distance
	}
	return 0
...
func (x *SpanningTreeMsg) GetSenderPkiId() []byte {
	if x != nil {
		return x.SenderPkiId
	}
	return nil
}

func (x *SpanningTreeMsg) GetPathCost() uint32 {
	if x != nil {
		return x.PathCost
	}
	return 0
...
var file_gossip_message_proto_rawDesc = []byte{
	...
	0x07, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x22, 0xc7, 0x0b, 0x0a, 0x0d, 0x47, 0x6f, 0x73,
	...
	0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x3e, 0x0a, 0x0d, 0x73, 0x70, 0x61, 0x6e, 0x6e, 0x69,
	0x6e, 0x67, 0x5f, 0x74, 0x72, 0x65, 0x65, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e,
	0x67, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x2e, 0x53, 0x70, 0x61, 0x6e, 0x6e, 0x69, 0x6e, 0x67, 0x54,
	0x72, 0x65, 0x65, 0x4d, 0x73, 0x67, 0x48, 0x00, 0x52, 0x0c, 0x73, 0x70, 0x61, 0x6e, 0x6e, 0x69,
	0x6e, 0x67, 0x54, 0x72, 0x65, 0x65, 0x22, 0x5f, 0x0a, 0x03, 0x54, 0x61, 0x67, 0x12, 0x0d, 0x0a,
	...
	,
	...
	0x67, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x42, 0x0c, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x50,
	...
	0x61, 0x70, 0x69, 0x76, 0x32, 0x2f, 0x67, 0x6f, 0x73, 0x73, 0x69, 0x70, 0xa2, 0x02, 0x03, 0x47,
	0x58, 0x58, 0xaa, 0x02, 0x06, 0x47, 0x6f, 0x73, 0x73, 0x69, 0x70, 0xca, 0x02, 0x06, 0x47, 0x6f,
	0x73, 0x73, 0x69, 0x70, 0xe2, 0x02, 0x12, 0x47, 0x6f, 0x73, 0x73, 0x69, 0x70, 0x5c, 0x47, 0x50,
	0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x06, 0x47, 0x6f, 0x73, 0x73,
...
var file_gossip_message_proto_msgTypes = make([]protoimpl.MessageInfo, 35)
var file_gossip_message_proto_goTypes = []any{
	...
	(*SpanningTreeMsg)(nil),              // 36: gossip.SpanningTreeMsg
	(*peer.CollectionConfigPackage)(nil), // 37: protos.CollectionConfigPackage
}
var file_gossip_message_proto_depIdxs = []int32{
	...
	36, // 23: gossip.GossipMessage.spanning_tree:type_name -> gossip.SpanningTreeMsg
	22, // 24: gossip.StateInfo.timestamp:type_name -> gossip.PeerTime
	7,  // 25: gossip.StateInfo.properties:type_name -> gossip.Properties
	35, // 26: gossip.Properties.chaincodes:type_name -> gossip.Chaincode
	2,  // 27: gossip.StateInfoSnapshot.elements:type_name -> gossip.Envelope
	0,  // 28: gossip.DataRequest.msg_type:type_name -> gossip.PullMsgType
	0,  // 29: gossip.GossipHello.msg_type:type_name -> gossip.PullMsgType
	2,  // 30: gossip.DataUpdate.data:type_name -> gossip.Envelope
	0,  // 31: gossip.DataUpdate.msg_type:type_name -> gossip.PullMsgType
	0,  // 32: gossip.DataDigest.msg_type:type_name -> gossip.PullMsgType
	18, // 33: gossip.DataMessage.payload:type_name -> gossip.Payload
	19, // 34: gossip.PrivateDataMessage.payload:type_name -> gossip.PrivatePayload
	37, // 35: gossip.PrivatePayload.collection_configs:type_name -> protos.CollectionConfigPackage
	25, // 36: gossip.AliveMessage.membership:type_name -> gossip.Member
	22, // 37: gossip.AliveMessage.timestamp:type_name -> gossip.PeerTime
	22, // 38: gossip.LeadershipMessage.timestamp:type_name -> gossip.PeerTime
	2,  // 39: gossip.MembershipRequest.self_information:type_name -> gossip.Envelope
	2,  // 40: gossip.MembershipResponse.alive:type_name -> gossip.Envelope
	2,  // 41: gossip.MembershipResponse.dead:type_name -> gossip.Envelope
	18, // 42: gossip.RemoteStateResponse.payloads:type_name -> gossip.Payload
	30, // 43: gossip.RemotePvtDataRequest.digests:type_name -> gossip.PvtDataDigest
	32, // 44: gossip.RemotePvtDataResponse.elements:type_name -> gossip.PvtDataElement
	30, // 45: gossip.PvtDataElement.digest:type_name -> gossip.PvtDataDigest
	2,  // 46: gossip.Gossip.GossipStream:input_type -> gossip.Envelope
	26, // 47: gossip.Gossip.Ping:input_type -> gossip.Empty
	2,  // 48: gossip.Gossip.GossipStream:output_type -> gossip.Envelope
	26, // 49: gossip.Gossip.Ping:output_type -> gossip.Empty
...
func file_gossip_message_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_gossip_message_proto_msgTypes[34].Exporter = func(v any, i int) any {
			switch v := v.(*SpanningTreeMsg); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_gossip_message_proto_msgTypes[3].OneofWrappers = []any{
		...
		(*GossipMessage_SpanningTree)(nil),
	}
	type x struct{}
